...
CREATE TABLE restaurant_owners (
    id SERIAL PRIMARY KEY,
    user_id INT NOT NULL UNIQUE, -- Odwołanie do tabeli users
...
CREATE TABLE restaurants (
    ...
    description TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_owner FOREIGN KEY(owner_id) REFERENCES restaurant_owners(id) ON DELETE CASCADE
);
...
-- Tabela powiązań kategorii z pozycjami menu
