...
public class UserControllerIntegrationTest {
    ...
    void testGetUserById() throws Exception {
        ...
        mockMvc.perform(get("/users/" + userId))
                .andExpect(status().isOk())
                .andExpect(view().name("user/detail")) // Sprawdzenie, czy widok jest poprawny
                .andExpect(model().attributeExists("user")) // Sprawdzenie, czy atrybut "user" istnieje
                .andExpect(model().attributeExists("user")) // Sprawdzenie, czy atrybut "users" istnieje
                .andExpect(model().attribute("user", hasProperty("username", is("testuser")))); // Sprawdzenie wartości atrybutu "user"
    }
