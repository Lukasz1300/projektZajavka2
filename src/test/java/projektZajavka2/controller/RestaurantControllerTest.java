...
@WebMvcTest(RestaurantController.class) // Testowanie tylko kontrolera RestaurantController
public class RestaurantControllerTest {
    ...
    public void shouldReturnRestaurantById() throws Exception {
        ...
        // Tworzenie restauracji i przypisanie właściciela
        Restaurant restaurant = new Restaurant();
        restaurant.setId(id);
        restaurant.setOwner(owner); // Ustawienie właściciela restauracji
