...
public class MenuItemRepositoryTest {
    ...
    public void setUp() {
        ...
        // Zakładając, że masz metodę save() w RestaurantOwnerRepository
        restaurantOwnerRepository.save(owner);

        // Wstaw przykładową restaurację
        restaurant = new Restaurant();
        restaurant.setOwner(owner);  // Ustawienie właściciela
        restaurant.setName("Test Restaurant");
        restaurant.setAddress("123 Test St");
        restaurantRepository.save(restaurant);

        // Wstaw przykładowe pozycje w menu
