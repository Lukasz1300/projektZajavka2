...
public class DeliveryAreaRepositoryTest {
    ...
    public void givenDeliveryAreas_whenFindByRestaurantId_thenReturnDeliveryAreas() {
        ...
        restaurantOwnerRepository.save(owner1);  //  zapisanie właściciela

        Restaurant restaurant2 = new Restaurant();
        restaurant2.setOwner(owner1); // Przypisanie właściciela
        ...
        restaurantRepository.save(restaurant2);  // zapisać restaurację
        ...
        // Testowanie metody findByRestaurantId
