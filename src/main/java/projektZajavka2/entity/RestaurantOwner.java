...
public class RestaurantOwner {
 ...
 //   @JsonIgnore nie trzeba gdy sie doda  @Transactional
...
//        // Metoda do zarządzania relacją
//        public void addRestaurant(Restaurant restaurant) {
//                restaurant.setOwner(this);   // Ustaw właściciela dla restauracji
//                this.restaurants.add(restaurant); // Dodaj restaurację do kolekcji
//        }
}
